...
\caption{Trade-off between perplexity (lower is better) and throughput (tokens/s, log-log scale) as sequence length grows. LST approaches Transformer-level perplexity while retaining the near-linear efficiency scaling of Mamba.}
