...
\usepackage{pgfplotstable}  % For loading tables from CSV
...
\pgfplotstabletypeset[
    ...
    columns/accuracy/.style={string type, column name=Illustrative Accuracy},
    columns/gflops_normalized/.style={string type, column name=Normalized GFLOPs},
]{LST/code/ssm_vs_attention.csv}
