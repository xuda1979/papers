...
\item \textbf{Astrophysical systematics.} Echo/sideband searches face nontrivial backgrounds; our protocol includes stringent controls (Alg.~\ref{alg:echo-stack}) but targeted pipelines are needed.
\end{itemize}
