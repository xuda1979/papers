...
\begin{enumerate}[label=\textup{(\roman*)}]
    ...
    \item $|\nabla u_p| > 0$ almost everywhere; equivalently, the critical set is negligible for the coarea and regular-value arguments used here;
...
\begin{theorem}[Hawking Mass Derivative Estimate {\cite[Theorem~4.1]{amo2022}}]\label{thm:amo-hawking-app}
...
In particular:
\begin{enumerate}[label=\textup{(\roman*)}]
    \item if $W(t) \leq 1$, then \eqref{eq:amo-key-bound} gives $\frac{d}{dt}m_H^2 \geq 0$;
