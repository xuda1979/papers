...
\begin{align*}
8\int_{\bM} |\nabla\phi|^2 \frac{d(\phi-1)}{d\phi} \, dV &+ \int_{\bM} R_{\bg}\phi(\phi-1) \, dV \\
...
\item \textbf{Pedagogy:} The two approaches demonstrate distinct techniques---maximum principles vs. integral identities---that may be useful in other contexts.
\end{enumerate}
\end{remark}
