...
\]
where $\rho_{\max}$ and $C_{\omega,\infty}$ depend on $(g, K)$, while $C_0>0$ is the logarithmic blow-up coefficient of the reference untwisted Jang solution near $\Sigma$.
