...
% Suppress minor typographic warnings (underfull/overfull boxes)
% These are cosmetic and do not affect content
\hbadness=10000          % Suppress underfull hbox warnings
\vbadness=10000          % Suppress underfull vbox warnings
\hfuzz=20pt              % Suppress overfull hbox warnings up to 20pt
\vfuzz=400pt             % Suppress overfull vbox warnings
