...
\begin{tikzpicture}[scale=0.75, transform shape,
    ...
    box/.style={rectangle, draw, rounded corners, text width=2.2cm, text centered, minimum height=1cm, font=\small},
    arrow/.style={->, thick}
]
...
\end{tikzpicture}
\caption{Logical structure of the proof. The dashed green arrow indicates the alternative proof path (Proposition~\ref{prop:alternative-mass}) bypassing the refined curvature bound. Both paths lead to the main theorem.}
\end{figure}
