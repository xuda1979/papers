...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Result} & \textbf{Hypotheses} & \textbf{Our Setting} & \textbf{OK?} \\
\midrule
Han--Khuri & $C^{3,\beta}_{\mathrm{loc}}$, $\tau > 1/2$, DEC & (H1), (H4) & \checkmark \\
Dain--Reiris & Axisym., vacuum, MOTS & (H1)--(H4) & \checkmark \\
AMO & $R_{\tg} \geq 0$, AF end & Thm.~\ref{thm:lich-exist} & \checkmark \\
Lockhart--McOwen & Asymp.\ cylindrical & Thm.~\ref{thm:jang-exist} & \checkmark \\
Mars--Simon & Vacuum, axisymmetric & (H2), (H3) & \checkmark \\
\bottomrule
\end{tabular}
