...
\begin{definition}[Axisymmetric Vacuum Data]\label{def:axi-vacuum}
...
\begin{definition}[Stationary-Axisymmetric Data]\label{def:stat-axi}
...
\begin{definition}[Simon Tensor]\label{def:simon-tensor}
...
\textbf{In summary:} $\Lambda_J$ is a \textbf{well-defined, coordinate-independent scalar} on $(M, g, K)$ that vanishes if and only if the data is a Kerr slice.
