...
%------------------------------------------------------------------
% 5. Bochner identity and singularity analysis
%------------------------------------------------------------------
...
\end{lemma}
\begin{proof}
From Lemma~\ref{lem:SharpBubbleAsymptotics}, the metric $\tilde{g}$ behaves asymptotically as a cone: $\tilde{g} \sim dr^2 + r^2 g_{S^2} + O(r^{2+\delta})$.
