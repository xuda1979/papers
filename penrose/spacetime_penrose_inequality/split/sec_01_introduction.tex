...
\begin{itemize}
    ...
    \item \textbf{Conditional Result:} The main theorem is conditional on the favorable jump condition ($\tr_\Sigma k \ge 0$) or on unproven conjectures (Conjecture C) in the general case.
\end{itemize}
