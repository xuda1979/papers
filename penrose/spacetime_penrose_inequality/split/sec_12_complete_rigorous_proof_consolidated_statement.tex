...
\begin{enumerate}[label=(A\arabic*)]
    \item \textbf{Favorable jump:} $\Sigma$ is a MOTS and $\tr_\Sigma k \ge 0$;
...
\begin{enumerate}
    ...
    \item \textbf{MOTS Penrose:} Apply Theorem~\ref{thm:penroseinitial} to $\Sigma^*$ (assuming $\Sigma^*$ satisfies the favorable jump condition, or proving it under additional assumptions).
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Cosmic Censorship + Spacetime Null Focusing (Penrose's Original):} Under weak cosmic censorship, Theorem~\ref{thm:Penrose1973Complete} applies via the past-directed null focusing argument (Lemma~\ref{lem:AreaComparison}). This is a \textbf{complete proof}.
