...
\textbf{Note:} This theorem describes an \textbf{alternative approach} using area comparison. The main proof of the Penrose inequality (Theorems~\ref{thm:MainTheorem}, \ref{thm:SPI}, \ref{thm:SPI_Core}) uses the \textbf{Jang Reduction for MOTS} (Theorem~\ref{thm:DirectTrappedJang}), which \textbf{bypasses area comparison entirely}. This section is retained for historical completeness.
