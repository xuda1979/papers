...
\begin{itemize}
    ...
    \item \textbf{Gap 3 (Area Comparison/OM):} COMPLETE under WCC via ingoing null focusing (Lemma~\ref{lem:AreaComparison})
...
\begin{itemize}
    ...
    \item \textbf{Hull in trapped region:} \textbf{NOT a route to favorable jump} in the present convention; a mean-convex hull that remains outer trapped forces $\tr_\Sigma k \le 0$ (Theorem~\ref{thm:HullJang})
