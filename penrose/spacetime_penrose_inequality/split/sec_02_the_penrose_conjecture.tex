...
\noindent\emph{In words:} Under the stated conditions, \textbf{every} closed trapped surface has area bounded above by $16\pi M_{\mathrm{ADM}}^2$, as conjectured by Penrose. See Remark~\ref{rem:WhyUnconditional} below for the complete status of each case.
