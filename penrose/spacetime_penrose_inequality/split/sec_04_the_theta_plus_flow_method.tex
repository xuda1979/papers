...
We now present the conditional reduction strategy furnished by the $\theta^+$-flow. \textbf{Note:} This approach requires the compactness conditions (C1)--(C3) of Theorem~\ref{thm:MaxAreaTrapped} for general trapped surfaces, and it remains auxiliary to the rigorous Jang--AMO core proof.
