...
\end{lemma}
\begin{proof}
If $\lambda_1 > 0$, the foliation by level sets of distance in the smoothing collar has strictly positive mean curvature $H > c > 0$ (due to the jump $[H]$). By the maximum principle, no minimal surface can enter this region without exiting it, forcing $\Sigma_\epsilon$ to essentially coincide with $\Sigma$.
