...
\begin{figure}[h!]
\centering
\input{fig/bpf_curves_generated.tex}
\caption{Budget--Performance Frontiers for Simulated Math Reasoning (SMR) and Simulated Code Generation (SCG). The plot compares Index-Guided Deliberation (IGD), UCB-IGD, Risk-Sensitive MCTT (RS-MCTT), Counterfactual Self-Consistency (CSC), and Abduction-Deduction-Refutation (ADR) across varying compute budgets.}
