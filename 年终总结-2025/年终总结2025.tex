...
\begin{frame}{技术突破(1)：量子噪声与AI量子纠错系统}
    ...
    \vspace{0.2cm}
    \begin{center}
        \colorbox{highlight!30}{\textbf{目标：持续完善系统，争取做到同类软件中的最好}}
    \end{center}
\end{frame}
...
\begin{frame}{技术突破(3)：量子科研与代码大模型}
    ...
    \vspace{0.3cm}
    \begin{center}
        \colorbox{cmccgreen!20}{\textbf{训练量子代码模型及开发编程智能体类似于Opus 4.5}}
    \end{center}
\end{frame}
...
\begin{frame}{人才培养}
    ...
    \begin{center}
        \colorbox{cmccblue!15}{
            \textbf{目标：深入加强团队AI能力，培养AI人才！开始AI赋能团队机制}
        }
    \end{center}
\end{frame}
...
\begin{frame}{问题与反思}
    ...
    \begin{block}{针对性改进措施}
        \begin{enumerate}
            \item 将量子与 AI 技术更紧密对接具体业务问题
            \item 深入研究提高大模型训练效率、降低训练费用的方法
            \item 深入研究Claude的技术，用于我们的模型训练和智能体开发
            \item 深入研究利用先进AI工具，辅助研究和开发
        \end{enumerate}
    \end{block}
\end{frame}
...
% ---------- 组织管理思考 ----------
\subsection{组织管理与人才培养思考}
\begin{frame}{未来工作思考 · 组织管理与人才培养}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[draw,rounded corners,fill=cmccgreen!20,minimum width=4.5cm,minimum height=3.5cm,align=center] at (4,0) {
                ...
                \footnotesize
                $\bullet$ 量子大模型v1.0发布，打造最好的同类软件\\
                $\bullet$ AI辅助科研解决方案不断提升\\
                $\bullet$ 深入加强团队AI能力，AI赋能团队机制\\
                $\bullet$ 算力与开发环境维护和升级\\
                $\bullet$ 高水平科研产出
            };
        \end{tikzpicture}
