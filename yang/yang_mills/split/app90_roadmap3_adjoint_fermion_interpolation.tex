...
\label{cor:free-energy-analytic-app90}
...
\label{thm:gap-analytic-app90}
The mass gap $\Delta(m)$ of Adjoint QCD (in the infinite-volume limit) is 
...
\subsection{Step 3: Decoupling Limit \texorpdfstring{$m \to \infty$}{m to infinity}}
...
\item Analyticity: $\Delta(m)$ is analytic for $m \in (0, \infty)$ 
      (Theorem~\ref{thm:gap-analytic-app90})
...
By Theorem~\ref{thm:gap-analytic-app90}, $\Delta(m)$ is analytic on $(0, \infty)$. 
