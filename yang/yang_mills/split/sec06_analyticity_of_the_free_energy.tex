...
\item \textbf{Intermediate coupling:} The multi-scale entropy method 
(Theorem~\ref{thm:multiscale-lsi}) provides rigorous uniform bounds 
through scale decomposition.
\end{enumerate}
\end{remark}
