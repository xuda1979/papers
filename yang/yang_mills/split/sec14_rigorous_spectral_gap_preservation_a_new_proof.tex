...
This section describes an earlier proof strategy (Mosco Convergence). The definitive rigorous proof of spectral gap preservation, based on Intrinsic Tightness and Spectral Permanence, is now presented in Appendix~\ref{sec:definitive-gap-closure}. This section is retained for historical completeness.
\end{remark}
...
Dirichlet form theory, Mosco convergence, and spectral stability estimates.
