...
\begin{abstract}
We present the finalized rigorous proof by resolving the "Intermediate Coupling" challenge. We do this by proving that the spectral gap $\Delta(\beta)$ is a subharmonic function on the complex coupling plane, protected by the exact preservation of Center Symmetry in the Adjoint QCD extension.
\end{abstract}
...
\begin{proof}[Proof of Hölder Continuity]
\textbf{Step 1: Gradient bound on gauge orbits.}
...
$N^2 - 1$ directions, the total gradient norm is bounded by $\sqrt{N^2-1} \cdot \|f\|_{C^1}$.
