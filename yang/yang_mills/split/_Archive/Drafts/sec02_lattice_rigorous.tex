...
\textbf{Status:} \textbf{Proven} for all $\beta > 0$. The existence and uniqueness of the limit follow from the non-vanishing of the mass gap (Theorem \ref{thm:thermo-positive}) and the resulting exponential decay of correlations, which ensures the extensivity of the free energy.
