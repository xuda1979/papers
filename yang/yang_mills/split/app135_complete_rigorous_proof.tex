...
\item \textbf{Weak coupling:} Multi-scale Entropy + Balaban's rigorous bounds
\item \textbf{Intermediate:} Cheeger Isoperimetric + RP Monotonicity
\item \textbf{Giles-Teper:} RP Variational Method + Casimir scaling
