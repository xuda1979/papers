...
\begin{theorem}[Uniform LSI - Section \ref{sec:definitive-gap-closure}]
\label{thm:stage2}
...
Using the Multi-Scale Entropy method (Appendix~\ref{sec:definitive-gap-closure}), we establish:
\begin{equation}
