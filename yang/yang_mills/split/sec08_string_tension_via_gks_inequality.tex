\section{String Tension and Positivity}
\label{sec:string}
...
\textbf{Note on Continuum Limit:}
The extension of the string tension bound to the continuum limit ($\beta \to \infty$) is established in Part IV (Appendix \ref{app:self_contained_proof} and Appendix \ref{app:gap_closures}) using global analyticity and center symmetry.
\end{tcolorbox}
...
using the character expansion and positivity properties.
