...
\label{thm:verification-checklist}
%=============================================================================
...
\subsubsection{Phase 2: Strong Coupling Anchor (\texorpdfstring{$\beta < \beta_c$}{beta < beta\_c})}
...
\subsubsection{Phase 3: The Intermediate Bridge (\texorpdfstring{$\beta_c < \beta < \beta_G$}{beta\_c < beta < beta\_G})}
...
\textbf{Method} (Section~\ref{sec:hierarchical-lsi}, Theorem~\ref{thm:block-zeg-sec12}):
\begin{itemize}
...
\begin{center}
\fbox{\textcolor{orange!80!black}{Framework: Theorem~\ref{thm:block-zeg-sec12} (uniform-in-$L$ requires verification)}}
\end{center}
...
\subsubsection{Phase 4: Continuum Limit (\texorpdfstring{$\beta \to \infty$}{beta to infinity})}
...
Intermediate coupling control & \checkmark & Theorem~\ref{thm:block-zeg-sec12} \\
