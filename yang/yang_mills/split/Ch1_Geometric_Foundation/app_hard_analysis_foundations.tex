...
\begin{conjecture}[Continuum Limit Existence]\label{thm:continuum-existence-hard}
For Yang-Mills theory with $G = SU(N)$, assuming the Uniform Log-Sobolev Inequality holds in the scaling limit:
\begin{enumerate}
...
\begin{proof}[Discussion of Spectral Gap Stability Strategy]
