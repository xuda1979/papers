...
\begin{proof}[Detailed Proof via Interpolation Norms]
    ...
    The action of the Continuum Hamiltonian $H = -\Delta + V$ compares to the Lattice Hamiltonian $H_a = -\Delta_a + V_a$.
    For any $\psi \in \mathcal{D}(H_a)$ with $\|\psi\|_a = 1$:
    \begin{align}
        \| (H \mathcal{J}_a - \mathcal{J}_a H_a) \psi \|_{L^2} &\le \| (\Delta \mathcal{J}_a - \mathcal{J}_a \Delta_a) \psi \| + \| (V \mathcal{J}_a - \mathcal{J}_a V_a) \psi \| \\
    ...
    The spectral shift is bounded by the norm of the resolvent difference:
    \begin{equation}
        \sup_{\lambda \in \text{Spec}(H)} \text{dist}(\lambda, \text{Spec}(H_a)) \le \| R(z) \mathcal{J}_a - \mathcal{J}_a R_a(z) \| \le C \cdot a^2 |\ln a|^{\gamma_0}
    \end{equation}
    ...
    \begin{equation}
        m(a) = m_{phys} + O(a^2 |\ln a|^{\gamma_0})
    \end{equation}
...
\begin{equation}
\left| \frac{m(a) - m_{phys}}{m_{phys}} \right| \le 0.45 \, a^2 \sigma (\ln(1/a\sqrt{\sigma}))^{7/11}
\end{equation}
