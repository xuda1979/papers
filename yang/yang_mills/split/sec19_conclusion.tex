...
\begin{enumerate}
\item \textbf{String tension for all $\beta$:} Rigorous via RP monotonicity and global analyticity
(Theorems~\ref{thm:rp-monotonicity-vortex} and \ref{cor:sigma-positive-all-beta} in Appendix~\ref{sec:app143-proofs})
...
(Theorem~\ref{thm:uniform-L-a} in Appendix~\ref{sec:app143-proofs})
\end{enumerate}
...
\]
(Theorem~\ref{thm:giles-teper-rigorous} in Appendix~\ref{sec:app143-proofs})
\end{theorem}
...
A mathematically rigorous bound $\Delta \geq \sigma$ using only standard functional 
...
% Relation to mass gap problem removed.
