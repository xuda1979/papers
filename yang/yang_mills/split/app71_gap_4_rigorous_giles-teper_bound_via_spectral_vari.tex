\section{Challenge 4: Rigorous Giles-Teper Bound via Spectral Variational Principle}
...
from effective string theory. For a mathematically rigorous lower bound $c_N \geq 2/N$
