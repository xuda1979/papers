...
\hline
Block decomposition & Theorem~\ref{thm:block-zeg-sec12} (Block Zegarlinski for Yang-Mills) & Section~\ref{sec:hierarchical-lsi} \\
Conditional tensorization & Theorem~\ref{thm:conditional-tensorization-sec12} & Section 11.3 \\
...
\item \textbf{Theorem~\ref{thm:verification-checklist}}: rigorous standard verification checklist (Section 16.1)
\end{itemize}
...
\item \textbf{Theorem~\ref{thm:block-zeg-sec12}:} Direct path via Dobrushin condition
