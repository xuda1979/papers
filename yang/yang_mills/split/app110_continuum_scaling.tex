...
%=============================================================================
\subsection{The Remaining Issue: String Tension Scaling}
%=============================================================================

The proof above used:
\[
\sigma_{phys} \to \sigma_\infty > 0 \quad \text{as } a \to 0
\]

This is \textbf{not} proven from first principles. It is:
\begin{enumerate}
\item Strongly supported by Monte Carlo simulations
\item Expected from dimensional transmutation
\item Consistent with phenomenology
\end{enumerate}

To prove this rigorously, we would need to show:
\[
\sigma_{lattice}(\beta) = \sigma_\infty \cdot a(\beta)^2 \cdot (1 + O(a))
\]

This is the \textbf{scaling hypothesis} for confinement.
