\section{Methods for the Yang-Mills Mass Gap}
...
%-----------------------------------------------------------------------------
\subsection{Stage 1: Strong Coupling (\texorpdfstring{$\beta < \beta_c$}{beta < beta\_c})}
%-----------------------------------------------------------------------------

\begin{theorem}[Strong Coupling Mass Gap --- Detailed]
\label{thm:strong-complete-app82}
...
%-----------------------------------------------------------------------------
\subsection{Stage 2: Intermediate Coupling (\texorpdfstring{$\beta_c < \beta < \beta_G$}{beta\_c < beta < beta\_G})}
...
%-----------------------------------------------------------------------------
\subsection{Stage 3: Weak Coupling (\texorpdfstring{$\beta > \beta_G$}{beta > beta\_G})}
%-----------------------------------------------------------------------------

We present \textbf{three approaches} to the weak coupling regime, in order of increasing rigor.

%=============================================================================
\subsubsection{Approach 1: Bootstrap Extension (Gauge-Invariant, mathematically rigorous)}
%=============================================================================
...
\begin{enumerate}
\item \textbf{Strong coupling} ($\beta < \beta_c$): Theorem \ref{thm:strong-complete-app82}
...
The key point: \textbf{uniform positivity} $\Delta \geq \delta > 0$ for all $\beta$ implies the 
...
\begin{enumerate}
\item[\checkmark] \textbf{Strong coupling:} Cluster expansion (Theorem \ref{thm:strong-complete-app82})
...
\subsubsection{Concern 5: SUSY Mass Gap at \texorpdfstring{$m=0$}{m=0}}

\textbf{Reviewer's concern:} ``The Adjoint QCD interpolation relies on the mass gap at 
$m=0$ (SYM), which is not proven to rigorous standards.''
