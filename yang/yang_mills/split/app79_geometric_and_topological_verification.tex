...
\[
\Delta(\beta) \geq c_N \sqrt{\sigma(\beta)} \quad \text{with } c_N = \sqrt{\frac{\pi}{3}}
\]
...
More precisely, the Giles-Teper bound states:
\[
\Delta \geq \sqrt{\frac{\pi}{3}} \sqrt{\sigma}
\]

The coefficient comes from the optimal flux tube profile minimizing energy 
subject to unit flux.
