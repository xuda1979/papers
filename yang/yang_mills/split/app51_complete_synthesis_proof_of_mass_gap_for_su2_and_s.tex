\section{Complete Synthesis: Proof of Mass Gap for \texorpdfstring{$SU(2)$}{SU(2)} and \texorpdfstring{$SU(3)$}{SU(3)}}
...
\begin{enumerate}
\item Inductive Uniform LSI (Theorem~\ref{thm:inductive-lsi})
