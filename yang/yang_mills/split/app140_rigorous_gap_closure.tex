...
\end{equation}
where $c_N = 2\sqrt{\pi/3}$ and $\sigma_{\mathrm{phys}} > 0$ is the physical string tension.
\end{theorem}
...
\end{equation}
The constant $c = 2\sqrt{\pi/3} \approx 2.05$ is sharp for the Nambu-Goto string.
\end{theorem}
...
\textbf{Step 4: Ground state energy.}

The ground state of a relativistic string with tension $\sigma$ satisfies:
\begin{equation}
E_0^2 = \sigma^2 R^2 + \frac{\pi \sigma (d-2)}{3} + O(1/R^2)
\end{equation}

For $d = 4$ and minimizing over $R$:
\begin{equation}
\Delta^2 = \inf_R E_0(R)^2 \geq \frac{4\pi \sigma}{3}
\end{equation}

Taking the square root: $\Delta \geq 2\sqrt{\pi\sigma/3}$.
...
Giles-Teper & $c_N = 2\sqrt{\pi/3}$ & $2.05$ / $2.05$ \\
