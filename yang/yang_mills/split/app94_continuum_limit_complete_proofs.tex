...
\]
in the sense of Definition~\ref{def:mosco-app89} (from app89).
\end{theorem}
...
physical box size. The Dirichlet form is normalized by the conventional factor $1/a^2$ 
implicit in the lattice Laplacian, which cancels the $a^2$ factor from the measure scaling 
in the kinetic term.
