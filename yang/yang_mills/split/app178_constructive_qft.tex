...
\textbf{Proof (Sketch):}
1.  \textbf{Lift:} The random field $A$ (Gaussian free field limit) is lifted to a random model $\mathbf{A}$.
2.  \textbf{Reconstruction:} The Reconstruction Theorem allows us to define the global distribution from local power series expansions.
3.  \textbf{Trace:} The trace operation commutes with the renormalization limits due to gauge invariance.
4.  \textbf{Conclusion:} The observable $W(C)$ is rigorously defined as a renormalized functional, independent of the regularization scheme.
