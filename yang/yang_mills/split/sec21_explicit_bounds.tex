...
Using the experimental string tension $\sqrt{\sigma} \approx 440 \text{ MeV}$, our proof rigorously predicts the lightest glueball mass is bounded by:
\begin{equation}
M_{0^{++}} \ge 3.14 \times 440 \text{ MeV} \approx 1380 \text{ MeV}
\end{equation}

(Note: Lattice QCD simulations observe $M_{0^{++}} \approx 1700 \text{ MeV}$, which satisfies our rigorous lower bound).
