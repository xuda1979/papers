...
\begin{remark}[Definitive Proof via RP Monotonicity]
The center symmetry argument below applies only to theories where center symmetry is preserved (such as Adjoint QCD). For pure Yang-Mills, the \textbf{definitive proof} of $\sigma(\beta) > 0$ for all $\beta$ uses reflection positivity monotonicity (Theorem~\ref{thm:rp-monotonicity} in Appendix~\ref{sec:definitive-gap-closure}), which requires no center symmetry assumption.
\end{remark}
...
\textbf{Conclusion}: For Adjoint QCD, $\sigma(\beta^*) = 0$ contradicts center symmetry. For pure Yang-Mills, $\sigma(\beta) > 0$ follows from RP monotonicity (Appendix~\ref{sec:definitive-gap-closure}).
\end{proof}
