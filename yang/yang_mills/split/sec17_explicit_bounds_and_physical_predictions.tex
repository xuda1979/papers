...
\begin{corollary}[Physical Mass Gap Estimate (Rigorous Lower Bound)]
\label{cor:physical-bound}
Based on effective string theory estimates, the physical mass gap of pure $SU(3)$ Yang-Mills theory is predicted to satisfy:
\[
...
\hline
\textbf{State} & \textbf{Lattice (MeV)} & \textbf{Rigorous Bound (MeV)} & \textbf{Ratio} \\
\hline
...
This is expected: the bounds are \emph{universal} lower bounds, not precise mass calculations.
