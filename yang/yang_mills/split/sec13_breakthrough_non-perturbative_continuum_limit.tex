...
This section describes an earlier proof strategy. The definitive rigorous proof of the continuum limit, based on Intrinsic Tightness and Multi-Scale Entropy, is now presented in Appendix~\ref{sec:definitive-gap-closure}. This section is retained for historical completeness.
\end{remark}

The previous sections established all lattice results rigorously. This 
section develops new mathematical techniques that complete the proof 
