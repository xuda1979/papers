...
\beta_{\text{RG}}(g) = -b_0 g^3 - b_1 g^5 + O(g^7), \quad b_0 = \frac{11N}{24\pi^2} > 0
\]
This implies $g(\mu) \to 0$ as $\mu \to \infty$, both perturbatively and non-perturbatively.

\textbf{Resolution:} Non-perturbative control of the RG flow is established via 
Balaban's renormalization group analysis combined with Hairer's regularity structures 
...
\item Therefore $R_\infty = \lim_{\beta \to \infty} R(\beta) = c_N \geq 2\sqrt{\pi/3}$ exists
\end{enumerate}
