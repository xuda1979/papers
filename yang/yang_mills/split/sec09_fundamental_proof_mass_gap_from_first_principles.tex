...
(Theorem~\ref{thm:hierarchical-lsi-sec13} in Section~\ref{sec:breakthrough}). The key insight 
...
via hierarchical Zegarlinski (Theorem~\ref{thm:hierarchical-lsi-sec13}).
\end{enumerate}
...
in Section~\ref{sec:breakthrough} via the uniform LSI bounds and dimensional 
transmutation. See Theorem~\ref{thm:final-gap} for the complete proof.
\end{theorem}
...
\textbf{Proof:} These are all established in Section~\ref{sec:breakthrough}:
\begin{itemize}
...
in Section~\ref{sec:breakthrough}, using Balaban's renormalization group analysis 
combined with Hairer's regularity structures for non-perturbative control.
\end{remark}
...
(Section~\ref{sec:breakthrough}, Theorem~\ref{thm:final-gap}).
