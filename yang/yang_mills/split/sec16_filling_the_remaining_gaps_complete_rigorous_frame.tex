...
\begin{remark}[Superseded Section]
This section describes earlier proof attempts. The definitive rigorous resolution of all critical gaps (including RP monotonicity, multi-scale entropy, and intrinsic tightness) is now presented in Appendix~\ref{sec:definitive-gap-closure}. This section is retained for historical completeness.
\end{remark}
