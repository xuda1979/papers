...
\begin{proof}
    ...
    The extension to all $\beta$ relies on the absence of phase transitions, supported by Reflection Positivity and uniform bounds.
    \begin{itemize}
        \item The Uniform Log-Sobolev Inequality (Section \ref{subsec:uniform_lsi}) ensures a strictly positive spectral gap for the transfer matrix for all finite $\beta$.
