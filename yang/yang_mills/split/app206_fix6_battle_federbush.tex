\section{Battle-Federbush Tree Decay: Temperedness of Schwinger Functions}
\label{ch:fix6_battle_federbush}
...
\subsection{The Schwinger Functions}
...
\textbf{Step 2: Tree Graph Bound.} By the cluster expansion (Appendix \ref{ch:fix28_mayer_montroll_radius}), each connected component is represented by polymers. The Battle-Federbush identity expresses the sum over partitions as a sum over spanning trees:
\begin{equation}
...
\subsection{Temperedness Implies Distribution}
...
\subsection{Exclusion of Hyperfunction Behavior}
