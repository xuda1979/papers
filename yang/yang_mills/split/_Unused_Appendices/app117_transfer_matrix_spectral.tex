...
\begin{definition}[1D Yang-Mills Chain (Principal Chiral Model)]
\label{def:1d-ym}
Consider $m$ sites on a 1D lattice with \textbf{pinned boundary conditions} ($U_0 = U_{m+1} = \mathbb{I}$):
\begin{equation}
S_{1D} = -\beta \sum_{i=0}^{m} \mathrm{Re}\,\mathrm{Tr}(U_i U_{i+1}^\dagger)
\end{equation}
...
\begin{equation}
Z_m(\beta) = \int_{SU(N)^m} \prod_{i=1}^m dU_i \, e^{\beta \sum_{i=0}^m \mathrm{Re}\,\mathrm{Tr}(U_i U_{i+1}^\dagger)}
\end{equation}
\end{definition}

\begin{remark}[Pinned vs. Periodic]
We use \textbf{Pinned Boundary Conditions} (Dirichlet) rather than Periodic. Periodic boundary conditions generally support a zero mode related to the center symmetry or global rotation, potentially closing the gap. Pinned boundaries explicitly break this symmetry, ensuring a strictly positive spectral gap uniform in system size, which is required for the LSI induction base case.
\end{remark}
...
\label{thm:character-expansion-117}
...
%=============================================================================
\subsection{Explicit Formulas for \texorpdfstring{$SU(2)$}{SU(2)}}
%=============================================================================
...
%=============================================================================
\subsection{Explicit Formulas for \texorpdfstring{$SU(3)$}{SU(3)}}
%=============================================================================
...
%=============================================================================
\subsection{General \texorpdfstring{$SU(N)$}{SU(N)} Formula}
%=============================================================================
