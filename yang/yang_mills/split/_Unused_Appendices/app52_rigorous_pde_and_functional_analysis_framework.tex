\section{Rigorous PDE and Functional Analysis Methods}
...
\subsection{Gap Resolution 1: Rigorous Proof of \texorpdfstring{$\sigma_{\text{phys}} > 0$}{sigma-phys > 0} via Variational Analysis}
