...
in $L$ for all $\beta > 0$ --- \textbf{Proven} (Theorem~\ref{thm:uniform-lsi-final})
...
\item Weak-coupling gap uses Convexity of Effective Action (Theorem~\ref{thm:uniform-lsi-final})
...
\item Continuum limit uses Intrinsic Tightness (Section~\ref{sec:gap4-resolution})
\end{itemize}
