\chapter{Derivation U: The Lattice BRST Cohomology (Unitarity)}
\label{ch:derivation_u_brst_unitarity}

\section{Context: Ghosts and Unitarity}
...
\section{Theorem U.1 (Positivity of the Physical Hilbert Space)}
...
\subsection{Step 2: Kugo-Ojima Quartet Mechanism}
We analyze the spectrum of the lattice Hamiltonian. States appear in "quartets" $\{ |\phi\rangle, Q_B|\phi\rangle, |\chi\rangle, Q_B|\chi\rangle \}$ (Forward/Backward Ghosts, Longitudinal/Scalar Gluons).
...
\subsection{Step 3: Homotopy Operator}
...
\subsection{Step 4: Metric Positivity}
