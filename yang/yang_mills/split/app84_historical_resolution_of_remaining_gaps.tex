...
\subsection{Gap 1: Continuum Non-Triviality (\texorpdfstring{$\sigma_{\mathrm{phys}} > 0$}{sigma > 0})}
...
\label{thm:lee-yang-adjoint-app84}
...
The hierarchical Zegarlinski bound (Theorem~\ref{thm:block-zeg-sec12}) can be verified 
numerically by:
\begin{enumerate}
...
transfer matrix spectral gap theory (Theorem~\ref{thm:1d-uniform-lsi-app76}).
\[
