...
\subsubsection{The \texorpdfstring{$L=2$}{L=2} Transfer Matrix}
...
\label{sec:microcausality-app167}
...
\subsubsection{Spectral Stability at \texorpdfstring{$\theta=0$}{theta=0}}
