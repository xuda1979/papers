...
Using the 2-loop asymptotic scaling for the lattice spacing:
\begin{equation}
a(\beta) \approx \frac{1}{\Lambda_{QCD}} \exp\left(-\frac{\beta}{2\beta_0 N}\right)
\end{equation}
we can express the condition for a finite physical mass gap as a constraint on the asymptotic behavior of the lattice gap as $\beta \to \infty$:
\begin{equation}
