...
\subsection{The Borel Summability Strategy (Heuristic)}
...
\textbf{Correction:} High-order perturbation theory in 4D Yang-Mills is \textbf{not Borel summable} due to Infrared Renormalons (fluctuations of low-momentum modes), as demonstrated by 't Hooft. The coefficients of the series grow as $n!$.
