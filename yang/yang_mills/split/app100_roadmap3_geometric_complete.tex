...
space has \textbf{positive Ricci curvature}, then the Bakry-Émery criterion 
...
%=============================================================================
\subsection{Step 1: Bakry-Émery Curvature Bound}
%=============================================================================
...
\textbf{weighted Ricci curvature} (Bakry-Émery) is:
\[
...
\textbf{Step 2: Weitzenböck formula.}
...
\begin{corollary}[Bakry-Émery Bound]
...
$CD(K, N)$ with:
\begin{itemize}
\item $K = \frac{4\pi^2}{g^2 L^2} - C(\beta)$ (Bakry-Émery curvature)
...
The argument:
\begin{enumerate}
\item Bakry-Émery curvature = geometric Ricci + Hessian of action
