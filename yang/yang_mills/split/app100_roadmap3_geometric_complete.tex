...
space has \textbf{positive Ricci curvature}, then the Bakry-\'Emery criterion 
...
%=============================================================================
\subsection{Step 1: Bakry-\'Emery Curvature Bound}
%=============================================================================
...
\textbf{weighted Ricci curvature} (Bakry-\'Emery) is:
\[
...
\textbf{Step 2: Weitzenb\'ockck formula.}
...
\begin{corollary}[Bakry-\'Emery Bound]
...
\]
where $S_N$ is the $N$-R\'enyinyi entropy.
...
With dimension correction ($N$-Bakry-\'Emery):
\[
\lambda_1 \geq \frac{K \cdot N}{N-1}
\]
\end{proof}
...
$CD(K, N)$ with:
\begin{itemize}
\item $K = \frac{4\pi^2}{g^2 L^2} - C(\beta)$ (Bakry-\'Emery curvature)
...
The argument:
\begin{enumerate}
\item Bakry-\'Emery curvature = geometric Ricci + Hessian of action
