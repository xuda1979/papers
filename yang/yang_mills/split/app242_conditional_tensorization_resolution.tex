...
\textbf{Step 4: Gaussian decay at weak coupling.}
For $\beta > \beta_G$, the measure is approximately Gaussian with correlation length $\xi \sim \beta^{-1/2}$. The connected correlation function decays as:
\begin{equation}
\langle U_x U_y \rangle_c \leq Ce^{-|x-y|/\xi}
\end{equation}
