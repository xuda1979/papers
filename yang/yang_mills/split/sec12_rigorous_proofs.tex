...
\textbf{Proof.} We define the continuum measure by its characteristic functional (Fourier transform). Let $f \in \mathcal{S}(\mathbb{R}^4)$ be a Schwartz test function. Define the lattice functional:
\begin{equation}
