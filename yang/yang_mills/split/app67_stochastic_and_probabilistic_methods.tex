...
The spectral gap $\lambda$ governs the rate of convergence to the stationary distribution (algorithmic mixing time).

Note: The spectral gap of the Langevin generator is explicitly \textbf{distinguished} from the physical mass gap $\Delta(\beta)$ of the Hamiltonian (transfer matrix). The former describes relaxation in fictitious time, the latter decay in Euclidean time. We use LSI to control the measure, but the physical gap is derived separately via the transfer matrix spectral representation.
\end{proof}
...
%=============================================================================
\begin{center}
\LARGE \textbf{Rigorous Resolution of All Critical Gaps}
\end{center}
\addcontentsline{toc}{section}{Rigorous Resolution of All Critical Gaps}
