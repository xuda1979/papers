...
The key stability condition for the hierarchical Logarithmic Sobolev Inequality (LSI) is the contraction of the variance transport operator. As derived in Appendix~\ref{sec:variance_transport_rigorous}, the global LSI constant $\rho_\Lambda$ satisfies:
\begin{equation}
