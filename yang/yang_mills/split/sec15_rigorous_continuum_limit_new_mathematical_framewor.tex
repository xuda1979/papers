...
This section describes an earlier proof strategy (Geometric Measure Theory). The definitive rigorous proof of the continuum limit is now presented in \textbf{Appendix~\ref{sec:definitive-gap-closure}}. This section is retained for historical completeness.
\end{tcolorbox}
