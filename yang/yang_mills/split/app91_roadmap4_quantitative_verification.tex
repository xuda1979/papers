...
\begin{theorem}[Giles-Teper Bound: Explicit Constant---Roadmap]
\label{thm:giles-teper-roadmap4}
...
c_N \geq \frac{2}{N}
\]
(see Theorem~\ref{thm:giles-teper-explicit} for the definitive derivation).
\end{theorem}
...
The Casimir scaling analysis (Theorem~\ref{thm:giles-teper-explicit}) gives:
\[
\Delta \geq \frac{2}{N} \sqrt{\sigma}
\]

\textbf{Step 4: Verification via reflection positivity.}
...
Lattice simulations confirm the Giles-Teper bound with values well above the lower bound:
\begin{center}
\begin{tabular}{|c|c|c|c|}
\hline
Group & $\Delta/\sqrt{\sigma}$ (measured) & $c_N$ (lower bound) & Satisfied \\
\hline
$SU(2)$ & $3.5 \pm 0.2$ & $\geq 1.0$ & \checkmark \\
$SU(3)$ & $3.7 \pm 0.2$ & $\geq 0.67$ & \checkmark \\
...
\label{thm:zegarlinski-constants-app91}
