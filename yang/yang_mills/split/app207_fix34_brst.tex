...
\end{equation}
The restriction to $\mathcal{M}$ is achieved via the Zwanziger horizon function, which does not affect the BRST cohomology (see Appendix \ref{ch:derivation_q_stratified_hardy} for the Hardy inequality treatment of Gribov boundaries).
\end{remark}
