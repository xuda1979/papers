...
This document is written as a \emph{rigorous foundations-and-roadmap} manuscript, explicitly designed to interface with the requirements of the \textbf{Clay Millennium Prize Problem}.
Appendix~\ref{ch:clay-blueprint} outlines the specific \textbf{"Rigorization Checklist"} derived from the Clay Institute/Jaffe--Witten problem description, and maps each technical component of this work to those requirements.
...
In particular, we aim to (i) make the verified parts of the argument fully rigorous (e.g., lattice reflection positivity, strong coupling expansions), and (ii) isolate the \textbf{"missing lemmas"} identified in Appendix~\ref{ch:clay-blueprint} that bridge the gap from strong coupling to the continuum scaling limit.
