...
and $c_N = 2\sqrt{\frac{\pi(N^2-1)}{6N^2}}$.
\end{enumerate}
\end{theorem}
...
\end{equation}
with $c_N = 2\sqrt{\frac{\pi(N^2-1)}{6N^2}}$.
\end{theorem}
...
The constant is:
\begin{equation}
c_N = 2\sqrt{\frac{\pi}{3}} \cdot \sqrt{\frac{C_2(F)}{C_2(adj)}} = 2\sqrt{\frac{\pi(N^2-1)}{6N^2}}
\end{equation}
\end{proof}
...
For $SU(2)$ and $SU(3)$:
\begin{align}
\Delta_{phys}^{SU(2)} &\geq 2\sqrt{\frac{\pi \cdot 3}{6 \cdot 4}} \sqrt{\sigma_{phys}} = \sqrt{\frac{\pi}{8}} \sqrt{\sigma_{phys}} \approx 0.627 \sqrt{\sigma_{phys}} \\
\Delta_{phys}^{SU(3)} &\geq 2\sqrt{\frac{\pi \cdot 8}{6 \cdot 9}} \sqrt{\sigma_{phys}} = \sqrt{\frac{4\pi}{27}} \sqrt{\sigma_{phys}} \approx 0.683 \sqrt{\sigma_{phys}}
\end{align}

With $\sqrt{\sigma_{phys}} \approx 440$ MeV:
\begin{align}
\Delta_{phys}^{SU(2)} &\gtrsim 276 \text{ MeV} \\
\Delta_{phys}^{SU(3)} &\gtrsim 300 \text{ MeV}
\end{align}
\end{theorem}
...
\item Our bound: $\gtrsim 300$ MeV
\end{itemize}
The bound is not saturated, which is expected since the variational estimate 
is a lower bound.
\end{remark}
