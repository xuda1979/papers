...
\input{sec_logical_spine.tex}
\input{sec13_uniform_lsi.tex}

\appendix
\input{action_definitions.tex}
\input{app_gap_equivalence.tex}
\input{app_interval_arithmetic.tex}
\input{app_norm_resolvent.tex}
