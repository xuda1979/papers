...
We now synthesize all the components into a complete, detailed proof 
...
\item[\textbf{IV.}] \textbf{Giles-Teper Bound} (Section~\ref{sec:giles-teper})
   ...
   \item $\Delta \geq c_N \sqrt{\sigma}$ with $c_N \geq 2/N$ (rigorous from RP variational)
   \end{itemize}
...
\]
for the lightest $0^{++}$ glueball. Our rigorous bound $c_N \geq 2/N$ (giving $\geq 0.67$ 
for $SU(3)$) is consistent with, though weaker than, the numerical value---as expected 
for a mathematical lower bound.
\end{remark}
