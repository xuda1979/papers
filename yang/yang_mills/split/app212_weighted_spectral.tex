...
\begin{theorem}[Bakry-\'Emery Criterion for LSI]\label{thm:bakry-emery}
...
\subsection{Computing $\mathrm{Ric}_V$ for Yang-Mills}
...
\subsection{The Correct $\beta$-Dependence}
