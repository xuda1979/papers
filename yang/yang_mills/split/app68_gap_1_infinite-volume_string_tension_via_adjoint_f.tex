\section{Challenge 1: Infinite-Volume String Tension via Adjoint Fermion Interpolation}
\label{sec:challenge1-adjoint}
%=============================================================================
%
% NOTE: This method using adjoint fermion interpolation works for Adjoint QCD
% but NOT for pure Yang-Mills. For the definitive proof of σ(β) > 0 for all β
% in pure Yang-Mills using RP monotonicity and Cheeger bounds, see
% Appendix~\ref{sec:definitive-gap-closure}.
%=============================================================================

\subsection{Strategy Overview}

\begin{remark}[Pure Yang-Mills vs Adjoint QCD]
The adjoint fermion interpolation method establishes the mass gap for the
family of theories with adjoint fermions. For pure Yang-Mills ($m \to \infty$ limit),
the definitive proof uses RP monotonicity (Appendix~\ref{sec:definitive-gap-closure},
Theorem~\ref{thm:rp-monotonicity}).
\end{remark}
...
\label{thm:lee-yang-adjoint-app68}
...
\begin{theorem}[String Tension Positivity for All $\beta$---Adjoint Method]
\label{thm:sigma-positive-all-beta-adjoint}
...
At $m = 0$ (SUSY point), by Theorem~\ref{thm:susy-gap-app68}, there is a mass gap 
$\Delta > 0$. The string tension is related to the mass gap by the Giles-Teper 
bound (proven in Section~\ref{sec:challenge4-giles-teper}):
\[
\sigma \geq c_N \Delta^2 > 0.
\]

\textbf{Step 2: Analyticity in $m$.}
By Theorem~\ref{thm:lee-yang-adjoint-app68}, the free energy density:
\[
...
(area law gives $\sigma \geq 0$). The vanishing of the string tension $\sigma$ 
would imply a phase transition (singularity), which contradicts the established 
analyticity in $m$.

\textbf{Step 4: Conclusion.}
Therefore $\sigma(\beta, m) > 0$ for all $m \geq 0$.

Taking $m \to \infty$, we recover the pure Yang-Mills result, establishing $\sigma > 0$ for the target theory.
\end{proof}
