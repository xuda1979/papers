...
Using the heat kernel representation, the Giles-Teper bound admits the form:
\[
\Delta \geq c_N \sqrt{\sigma}, \quad c_N = 2\sqrt{\frac{\pi}{3}} \cdot f_N
\]
where:
\[
f_N = \sqrt{\frac{\lambda_1(SU(N))}{\lambda_1(SU(N)) + N}} = \sqrt{\frac{N^2-1}{N^2-1 + 2N^2}} = \sqrt{\frac{N^2-1}{3N^2-1}}
\]
...
\hline
$N$ & $\lambda_1(SU(N))$ & $f_N$ & $c_N$ \\
\hline
2 & $3/4$ & $\sqrt{3/11} \approx 0.522$ & 1.07 \\
3 & $4/3$ & $\sqrt{8/26} \approx 0.555$ & 1.14 \\
$\infty$ & $N/2$ & $1/\sqrt{3} \approx 0.577$ & 1.18 \\
\hline
\end{tabular}
\end{center}
\end{theorem}
...
\end{enumerate}
Therefore $R(\beta) \to R_{\mathrm{phys}} = c_N \geq 2\sqrt{\pi/3}$ as $\beta \to \infty$.
\end{tcolorbox}
