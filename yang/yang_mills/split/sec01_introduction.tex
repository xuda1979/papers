...
\item \textbf{Intermediate} ($\beta_c < \beta < \beta_G$): Cheeger isoperimetric + RP monotonicity (\S\ref{sec:innovative-gap-resolution})
\item \textbf{Weak coupling} ($\beta > \beta_G$): Multi-scale entropy + Gaussian dominance (\S\ref{sec:innovative-gap-resolution})
