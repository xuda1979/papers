\section{Method 2: Octonion-Enhanced Curvature for \texorpdfstring{$SU(3)$}{SU(3)}}
\label{sec:octonion}
%=============================================================================
...
\subsection{The Exceptional Geometry of \texorpdfstring{$SU(3)$}{SU(3)}}
...
\subsection{Log-Sobolev Enhancement for \texorpdfstring{$SU(3)$}{SU(3)}}
...
\subsection{Resolving the \texorpdfstring{$7/9$}{7/9} Problem}
