...
\begin{proof}[Proof of Theorem \ref{thm:uniform-lsi-main}]
    ...
    \end{equation}
    where $\epsilon_k \sim e^{-L_k}$. Since $\sum \epsilon_k < \infty$, the infinite product $\prod (1-\epsilon_k)$ converges to a non-zero value $\rho_*$.
    
    Thus, $\rho_L \ge \rho_* > 0$ uniform in $L$.
\end{proof}
\begin{enumerate}
