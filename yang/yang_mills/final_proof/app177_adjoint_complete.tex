\section{Adjoint Fermion Interpolation: Complete Proof}
\label{app:adjoint-complete}
%=============================================================================
...
\label{thm:susy-gap-app99}
The supersymmetric gap is:
\begin{enumerate}
...
\label{thm:lee-yang-adjoint-app99}
...
\label{cor:free-energy-analytic-app99}
...
From Theorem~\ref{thm:susy-gap-app99}:
\[
\Delta(0) > 0
\]
...
From Theorem~\ref{thm:gap-analytic-app99}:
\[
...
(Theorem~\ref{thm:global-analyticity-mixing}).
