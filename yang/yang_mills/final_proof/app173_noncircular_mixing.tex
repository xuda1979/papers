...
\textbf{Note: This appendix proves that Theorem \ref{thm:lve-convergence} (RG-Stability) implies exponential mixing. This implication is Step 3 of the Rigorous Proof Chain.}
...
We now present the standard clean statement and proof demonstrating that uniform convexity implies Dobrushin uniqueness.

\begin{theorem}[Uniform convexity + local interactions $\Rightarrow$ Dobrushin uniqueness]
\label{thm:balaban-convexity}
\label{lem:rg-convexity}
