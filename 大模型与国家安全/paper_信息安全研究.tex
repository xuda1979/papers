...
\begin{table}[htbp]
\centering
\caption{大模型安全风险评估矩阵\\{\small\textnormal{Table 1\quad Security Risk Assessment Matrix for LLMs}}}
...
\end{tcolorbox}
\caption{大模型安全风险传导机制\\{\small\textnormal{Fig.1\quad Risk Transmission Mechanism of LLMs}}}
...
L4：审查输出内容，阻断敏感信息泄露
\end{tcolorbox}
\caption{四层安全网关架构\\{\small\textnormal{Fig.2\quad Four-Layer Security Gateway Architecture}}}
...
\begin{table}[H]
\centering
\caption{四层安全网关评估指标\\{\small\textnormal{Table 2\quad Evaluation Metrics for Four-Layer Security Gateway}}}
