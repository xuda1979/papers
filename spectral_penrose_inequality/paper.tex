...
Let $g_0$ satisfy $R_{g_0} \ge 0$ (as provided by the Jang reduction). The flow \eqref{eq:flow_system} admits a unique smooth solution $u(x,t)$ for all $t \in [0, \infty)$.
\end{theorem}
