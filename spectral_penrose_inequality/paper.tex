...
We apply the Divergence Theorem. On the boundary $\partial\Omega$, we have $\phi=1$. Examining the definition of $Y$, we see that $Y|_{\partial\Omega} = 0$. Thus, the boundary integral vanishes.
