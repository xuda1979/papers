...
\end{equation}
Given the boundary conditions and $R_{g_t} \ge 0$, the right hand side is strictly non-positive. Thus, $M_{ADM}(g_t)$ is monotonically decreasing.
\end{proof}
...
The limit metric $g_\infty$ is asymptotically flat with zero scalar curvature. We invoke the Riemannian Penrose Inequality, rigorously proven by Bray (2001) and Huisken-Ilmanen (2001):
\begin{equation}
