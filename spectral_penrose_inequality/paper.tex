...
\end{lemma}
\begin{proof}
Let $p_k$ be one of the singular points. By construction (Theorem \ref{thm:Deformation}), the metric $\tg$ near $p_k$ is $\tg = \phi^4 \bg \approx s^2(ds^2+g_{\mathcal{B}})$ where $s$ is the regularized distance to the singularity. The volume element is $d\text{Vol}_{\tg} \approx s^2 dV_{S^2} ds$.
...
\end{align*}
The volume of the annulus is $\text{Vol}_{\tg}(A_\epsilon) = \int_{S^2} \int_\epsilon^{2\epsilon} s^2 ds d\sigma_{S^2} = 4\pi [\frac{s^3}{3}]_\epsilon^{2\epsilon} = 4\pi(8\epsilon^3/3 - \epsilon^3/3) = \frac{28\pi}{3}\epsilon^3$.
